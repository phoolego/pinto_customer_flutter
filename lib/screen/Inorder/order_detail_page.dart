    ...
    return Scaffold(
      ...
      body: SafeArea(
          child: Container(
            ...
            child: Column(
              children: [
                Text('สถานะ : ${widget.order.getStatus()}',style: kHeadingTextStyle,),
                Divider(thickness: 2,),
                Text('จัดส่งไปที่ : ${widget.order.destination}',style: kHeadingTextStyle,),
                Divider(thickness: 2,),
                Expanded(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text('${widget.order.orderItems[index].productType}',
                                      style: kContentTextBlack
                                  ),
                                  Text('${widget.order.orderItems[index].amount} ${widget.order.orderItems[index].unit}',style: kContentTextBlack,)
                                ],
                              ),
                              Text('${widget.order.orderItems[index].price} บาท',style: kContentTextBlack,)
                            ],
                          ),
                        );
                      }),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('ค่าจัดส่ง :',style: kContentTextBlack,),
                    Text('${widget.order.deliveryPrice} บาท',style: kContentTextBlack,),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('รวมการสั่งซื้อ : ',style: kContentTextBlackBold,),
                    Text('${totalPrice+widget.order.deliveryPrice} บาท',style: kContentTextBlackBold,),
                  ],
                ),
                Divider(thickness: 2,),
                Center(
