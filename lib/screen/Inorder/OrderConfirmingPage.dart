...
class OrderConfirmingPage extends StatefulWidget {
  String status = '';
  OrderConfirmingPage({required this.status,
  });
  @override
  State<OrderConfirmingPage> createState() => _OrderConfirmingPageState();
}
